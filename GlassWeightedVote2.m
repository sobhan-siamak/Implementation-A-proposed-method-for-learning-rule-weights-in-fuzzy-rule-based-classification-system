                     ...
                     %%%%%%%% calculate score for selected rule in weighted vote
                            ...
                            for k=1:m
                                    ...
                                    for j=1:240
                                     ...
                                     if(glassRBFinal(i,5)==1)
                                         enmax=[en2 en3 en5 en6 en7];
                                     end
                                     if(glassRBFinal(i,5)==2)
                                         enmax=[en1 en3 en5 en6 en7];
                                     end
                                     if(glassRBFinal(i,5)==3)
                                         enmax=[en1 en2 en5 en6 en7];
                                     end
                                     if(glassRBFinal(i,5)==5)
                                         enmax=[en1 en2 en3 en6 en7];
                                     end
                                     if(glassRBFinal(i,5)==6)
                                         enmax=[en1 en2 en3 en5 en7];
                                     end
                                     if(glassRBFinal(i,5)==7)
                                         enmax=[en1 en2 en3 en5 en6];
                                     end
...
RuleWV=sum(Rulescnt)/214;
AccFinalWV=sum(Accuracy)/214;


%%%%%%%%%% Display Average of  Final Rules
disp('***********************************');
disp('***********************************');
disp('************** Average Rule Base Glass dataset in weighted vote with leave one out is *****************');
disp(RuleWV);
disp('************************************************');
disp('************************************************');
disp('************************************************');
disp('Average Accuracy in Glass dataset on test data with weighted vote with leave one out is');
disp(AccFinalWV);
