       ...
       ErrateTotal1=zeros(300,1);%%%%%%% Error rate in single winner
         ...
         for i=1:300
                ...
                %%%%%
                 ...
                 for j=1:177
                     ...
                     if(( mx1==cnum1 && mx1==cnum2) || (mx1==cnum1 && mx1==cnum3) || (mx1==cnum2 && mx1==cnum3) )
                             flag1=1;
                             infinit(j,3)=-1;
                     end
        ...
        %%%% 
                ...
                for j=1:177
                    ...
                    [mx2,index2]=max(cnm);
    %%%%%%%% checking for having two max with diff consequent
                     if((mx2==cnm1 && mx2==cnm2)|| (mx2==cnm1 && mx2==cnm3) || (mx2==cnm2 && mx2==cnm3) )
                         flag2=1;
                         z(j,3)=-1;
                     end
        ...
        cnum3=0;%%%%%%number of class3
          ...
          [mx1,index1]=max(cnum);%%%%%% 
          if((mx1==cnum1 && testLabel==1) || (mx1==cnum2 && testLabel==2) || (mx1==cnum3 && testLabel==3))
              Accuracy(it)=1;
          else
              Accuracy(it)=0;
          end
...
RuleWV=sum(Rulescnt)/178;
AccFinalWV=sum(Accuracy)/178;

%%%%%%%%%% Display Average of  Final Rules
disp('***********************************');
disp('***********************************');
disp('************** Average Rule Base in weighted vote with leave one out is *****************');
disp(RuleWV);
disp('************************************************');
disp('************************************************');
disp('************************************************');
disp('Average Accuracy in Wine dataset on test data with weighted vote with leave one out is');
disp(AccFinalWV);
