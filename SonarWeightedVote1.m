...
%% Step4             Rule weigting and Rule Reduction in weigthed vote Method
       ...
       %%%%% weghting with 0 weight
        ...
        for j=1:208
            ...
            if(mx2==cnm1 && mx2==cnm2)
                ...
                z(j,1)=index2;%%%% the 3th ellement is class of each rule      
                if(z(j,1)==z(j,2))
...
%                 if(sonarRBFinal(i,3)==1)
%                     enmax=en2;
%                 end
%                 if(sonarRBFinal(i,3)==2)
%                     enmax=en1;
%                 end
%                 
                enmax=[en1 en2];
...
for i=1:208
    ...
    classSW(i,1)=index1;%%%% the 3th ellement is class of each rule   
...
disp(['Accuracy in Wine dataset Single Winner without leave one out is: ' num2str(AccFinalWV)]);
